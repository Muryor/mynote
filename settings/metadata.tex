...
% 当前配置：
% 当前配置：
\newcommand{\examSourceFile}{content/exams/auto/nanjing_2026_sep/nanjing_2026_sep_preprocessed.tex}

% 可选：试卷显示名称（用于识别，非必须）
\newcommand{\examDisplayName}{南京 2026 年 9 月试卷（v1.6.3 analysis fix test）}
