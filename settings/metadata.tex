...
%
% 当前配置：
\newcommand{\examSourceFile}{content/exams/auto/nanjing_yancheng_2025_mock1/converted_exam.tex}

% 可选：试卷显示名称（用于识别，非必须）
\newcommand{\examDisplayName}{江苏省南京市、盐城市2024-2025学年高三下学期第一次模拟考试数学试题}
