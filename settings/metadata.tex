...
% 
% 示例（英文路径 - 推荐）：
%   \newcommand{\examSourceFile}{content/exams/auto/lishui_2026_nov/converted_exam.tex}
%
% 示例（中文路径 - macOS 测试）：
%   \newcommand{\examSourceFile}{content/exams/auto/lishui_2026_nov/converted_exam.tex}
%
% 当前配置：
% Switched to gaokao 2024 for this build request
\newcommand{\examSourceFile}{content/exams/auto/gaokao_2024_national_1/converted_exam.tex}

% 可选：试卷显示名称（用于识别，非必须）
\newcommand{\examDisplayName}{江苏省常州市2025-2026学年高三上学期11月期中质量调研数学试题}
