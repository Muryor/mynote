...
% CONTEXT_AFTER: {width="1.5416666666666667in" height="1.46875in"}
...
height="1.8020833333333333in"}\(\frac{3}{2}\).}
\end{question}
...
% IMAGE_TODO_START id=nanjing_2026_sep-Q17-img2 path=/Users/muryor/code/mynote/word\_to\_tex/output/figures/raw/media/image5.png width=60% inline=true question_index=17 sub_index=1
% CONTEXT_BEFORE: $平面\(A_{1}C_{1}CA\)，故\(NM//\)平面\(A_{1}C_{1}CA\).
% CONTEXT_AFTER: {width="1.7916666666666667in" height="1.59375in"}
\begin{tikzpicture}[scale=0.8,baseline=-0.5ex]
...
% IMAGE_TODO_START id=nanjing_2026_sep-Q17-img3 path=/Users/muryor/code/mynote/word\_to\_tex/output/figures/raw/media/image6.png width=60% inline=true question_index=17 sub_index=1
% CONTEXT_BEFORE: rt{7} \times 2\sqrt{3}} = \frac{\sqrt{21}}{7}\(.
% CONTEXT_AFTER: {width="1.9375in" height="1.8229166666666667in"}
\begin{tikzpicture}[scale=0.8,baseline=-0.5ex]
...
如图：
% IMAGE_TODO_START id=nanjing_2026_sep-Q18-img1 path=/Users/muryor/code/mynote/word\_to\_tex/output/figures/raw/media/image7.png width=60% inline=true question_index=18 sub_index=1
% CONTEXT_BEFORE: {2}\) \(\Rightarrow\) \(|AB| = 6\sqrt{2}\). 如图：
% CONTEXT_AFTER: {width="1.84375in" height="1.53125in"} 因为F_{2}(
\begin{tikzpicture}[scale=0.8,baseline=-0.5ex]
