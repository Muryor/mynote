...
% IMAGE_TODO_START id=comparison_legacy-Q6-img1 path=/Users/muryor/code/mynote/word\_to\_tex/output/figures/nanjing\_yancheng\_2025\_mock1/media/image2.png width=60% inline=true question_index=6 sub_index=1
% CONTEXT_BEFORE: 用射影定理即可化简求值. 【详解】如图所示，过点*A*作\(AD\bot BC\)于点*D*，
% CONTEXT_AFTER: {width="1.9583333333333333in" height="1.15625in"}
\begin{tikzpicture}[scale=0.8,baseline=-0.5ex]
  % TODO: AI_AGENT_REPLACE_ME (id=comparison_legacy-Q6-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=comparison_legacy-Q6-img1{width="1.9583333333333333in"
height="1.15625in"}
...
\begin{choices}
  \item \(\text{sin}\alpha\text{sin}\beta = \frac{1}{12}\)
...
\begin{choices}
  \item 直线\(A'C\)与直线\(BD\)所成角为\(\frac{\text{π}}{2}\)
...
\par
% IMAGE_TODO_START id=comparison_legacy-Q10-img1 path=/Users/muryor/code/mynote/word\_to\_tex/output/figures/nanjing\_yancheng\_2025\_mock1/media/image3.png width=60% inline=true question_index=10 sub_index=1
% CONTEXT_BEFORE: 外接球的表面积为\(4 \times 2 = 8\)，故D正确.
% CONTEXT_AFTER: {width="2.84375in" height="1.5104166666666667in"}
\begin{tikzpicture}[scale=0.8,baseline=-0.5ex]
  % TODO: AI_AGENT_REPLACE_ME (id=comparison_legacy-Q10-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=comparison_legacy-Q10-img1{width="2.84375in"
...
\par
% IMAGE_TODO_START id=comparison_legacy-Q13-img1 path=/Users/muryor/code/mynote/word\_to\_tex/output/figures/nanjing\_yancheng\_2025\_mock1/media/image4.png width=60% inline=true question_index=13 sub_index=1
% CONTEXT_BEFORE: + y^{2} = 1\(有两个交点，符合题意. \){4}\(.
% CONTEXT_AFTER: {width="1.8125in" height="1.6041666666666667in"}
\begin{tikzpicture}[scale=0.8,baseline=-0.5ex]
  % TODO: AI_AGENT_REPLACE_ME (id=comparison_legacy-Q13-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=comparison_legacy-Q13-img1{width="1.8125in"
...
\par
% IMAGE_TODO_START id=comparison_legacy-Q15-img2 path=/Users/muryor/code/mynote/word\_to\_tex/output/figures/nanjing\_yancheng\_2025\_mock1/media/image6.png width=60% inline=true question_index=15 sub_index=1
% CONTEXT_BEFORE: \bot AC,CD\bot BC\). 以\(C\)为坐标原点建立如图所示的空间直角坐标系，
% CONTEXT_AFTER: {width="1.8541666666666667in" height="1.625in"} 因
\begin{tikzpicture}[scale=0.8,baseline=-0.5ex]
  % TODO: AI_AGENT_REPLACE_ME (id=comparison_legacy-Q15-img2)
\end{tikzpicture}
% IMAGE_TODO_END id=comparison_legacy-Q15-img2{width="1.8541666666666667in"
height="1.625in"}
\par
...
\item 已知甲先上场，\(p = \frac{1}{2},q = \frac{1}{3},n = 2\)，
...
\item 当\(a = 0\)时，求证：\(\frac{f(x)}{x} > x + 1\)；
...
\item 已知圆\(C_{1}:x^{2} + y^{2} = 1\)为\(M_{1}\)的包络曲线，判断直线\(l:x\text{sin}\theta - y\text{cos}\theta = 1\)(\(\theta\)为常数，\(\theta \in R\))与集合\(M_{1}\)的关系；
...
故\)\frac{|FA|}{|FP|}\(的最大值为\)\frac{1 + \sqrt{5}}{2}.
\par
% IMAGE_TODO_START id=comparison_legacy-Q19-img1 path=/Users/muryor/code/mynote/word\_to\_tex/output/figures/nanjing\_yancheng\_2025\_mock1/media/image7.png width=60% inline=true question_index=19 sub_index=1
\begin{tikzpicture}[scale=0.8,baseline=-0.5ex]
  % TODO: AI_AGENT_REPLACE_ME (id=comparison_legacy-Q19-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=comparison_legacy-Q19-img1{width="1.8541666666666667in"
