...
\begin{center}
% IMAGE_TODO_START id=auto_84b5b6-Q5-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_84b5b6/media/image2.png width=60% inline=false question_index=5 sub_index=1
% CONTEXT_BEFORE: xt{π} ) )$$的图像如图所示，则$$f(x) =$$( )
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_84b5b6-Q5-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_84b5b6-Q5-img
1
\end{center}
...
\begin{center}
% IMAGE_TODO_START id=auto_84b5b6-Q11-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_84b5b6/media/image3.png width=60% inline=false question_index=11 sub_index=1
% CONTEXT_BEFORE: $$所在的平面相互垂直，$$AC \cap BD = O$$，$$AB = 2$$．( )
% CONTEXT_AFTER: > A．$$BD$$ $$\parallel$$平面$$CEF$$ > > B．二面角$$A -
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_84b5b6-Q11-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_84b5b6-Q11-img
1
\end{center}


\begin{center}
% IMAGE_TODO_START id=auto_84b5b6-Q11-img2 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_84b5b6/media/image4.png width=60% inline=false question_index=11 sub_index=1
% CONTEXT_BEFORE: $D$$为原点，$$DA,DC,DE$$分别为$$x,y,z$$轴建立空间直角坐标系，如图所示：
% CONTEXT_AFTER: 因为$$AB = 2$$，所以$$BD = 2$$， 则$$A(2,0,0)$
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_84b5b6-Q11-img2)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_84b5b6-Q11-img
2
\end{center}
...
\begin{center}
% IMAGE_TODO_START id=auto_84b5b6-Q11-img3 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_84b5b6/media/image5.png width=60% inline=false question_index=11 sub_index=1
% CONTEXT_BEFORE: $$P_{2}$$，连接$$P_{1}P_{2},OP_{1},OP_{2}$$，$$AC$$，
% CONTEXT_AFTER: 所以$$P_{1}P_{2}//EF$$，$$EF \subset$$平面$$EFC$$，$$P
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_84b5b6-Q11-img3)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_84b5b6-Q11-img
3
\end{center}
...
\begin{center}
% IMAGE_TODO_START id=auto_84b5b6-Q16-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_84b5b6/media/image6.png width=60% inline=false question_index=16 sub_index=1
% CONTEXT_BEFORE: $$PA\bot$$底面$$ABCD$$且$$PA = 4$$，$$E$$是$$PA$$的中点．
% CONTEXT_AFTER: (1)证明：平面$$PBD\bot$$平面$$PAC$$； (2)求$$BE$$与平面$$PA
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_84b5b6-Q16-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_84b5b6-Q16-img
1
\end{center}


\begin{center}
% IMAGE_TODO_START id=auto_84b5b6-Q16-img2 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_84b5b6/media/image7.png width=60% inline=false question_index=16 sub_index=1
% CONTEXT_BEFORE: 法一：设$$AC \cap BD = O$$，由(1)知$$BO\bot$$平面$$PAC$$．
% CONTEXT_AFTER: 则$$\angle BEO$$为$$BE$$与平面$$PAC$$所成角． $$\because
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_84b5b6-Q16-img2)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_84b5b6-Q16-img
2
\end{center}
...
\begin{center}
% IMAGE_TODO_START id=auto_84b5b6-Q16-img3 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_84b5b6/media/image8.png width=60% inline=false question_index=16 sub_index=1
% CONTEXT_AFTER: 为基底建立空间直角坐标系．则有： $$A(0,0,0),B( 2,
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_84b5b6-Q16-img3)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_84b5b6-Q16-img
3
\end{center}
...
\begin{center}
% IMAGE_TODO_START id=auto_84b5b6-Q18-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_84b5b6/media/image9.png width=60% inline=false question_index=18 sub_index=1
% CONTEXT_BEFORE: t{sin}A \neq 0$$，∴$$C = {2}$$．
% CONTEXT_AFTER: (2)①$$\because C \in \left( 0, \right),\
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_84b5b6-Q18-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_84b5b6-Q18-img
1
\end{center}
