...
\begin{center}
% IMAGE_TODO_START id=auto_87a1b0-Q14-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_87a1b0/media/image2.png width=60% inline=false question_index=14 sub_index=1
...
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_87a1b0-Q14-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_87a1b0-Q14-img
1
\end{center}
