...
\begin{center}
% IMAGE_TODO_START id=auto_7d291d-Q5-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_7d291d/media/image2.png width=60% inline=false question_index=5 sub_index=1
...
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_7d291d-Q5-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_7d291d-Q5-img
1
\end{center}
...
%
\begin{center}
% IMAGE_TODO_START id=auto_7d291d-Q7-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_7d291d/media/image3.png width=60% inline=false question_index=7 sub_index=1
% CONTEXT_BEFORE: a$$的取值范围是$$(6, + \infty)$$. } > 36$$
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_7d291d-Q7-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_7d291d-Q7-img
1
\end{center}
%
...
%
\begin{center}
% IMAGE_TODO_START id=auto_7d291d-Q11-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_7d291d/media/image4.png width=60% inline=false question_index=11 sub_index=1
% CONTEXT_BEFORE: 所在直线为旋转轴，将容器逆时针旋转$$90{^\circ}$$的过程中，下列说法正确的是( )
% CONTEXT_AFTER: > A．水面形状的变化依次为三角形，等腰梯形，矩形 > > B．水面可能是正三角形 > > C．
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_7d291d-Q11-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_7d291d-Q11-img
1
\end{center}
%

\begin{center}
% IMAGE_TODO_START id=auto_7d291d-Q11-img2 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_7d291d/media/image5.png width=60% inline=false question_index=11 sub_index=1
% CONTEXT_BEFORE: 为$$S_{▭DEFG} = DE \cdot DG = 4$$，故D选项正确.
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_7d291d-Q11-img2)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_7d291d-Q11-img
2
\end{center}
...
%
\begin{center}
% IMAGE_TODO_START id=auto_7d291d-Q17-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_7d291d/media/image6.png width=60% inline=false question_index=17 sub_index=1
% CONTEXT_BEFORE: B_{1}BCC_{1}$$为矩形，$$A_{1}$$在底面$$ABC$$内的射影为$$O$$．
% CONTEXT_AFTER: (1)求证：$$AO\bot BC$$且$$OB = OC$$； (2)若$$BC = OA
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_7d291d-Q17-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_7d291d-Q17-img
1
\end{center}
%

\begin{center}
% IMAGE_TODO_START id=auto_7d291d-Q17-img2 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_7d291d/media/image7.png width=60% inline=false question_index=17 sub_index=1
% CONTEXT_BEFORE: O$$并延长交$$BC$$于点$$D$$，连接$$A_{1}B,A_{1}C,A_{1}D$$，
% CONTEXT_AFTER: 因为$$A_{1}$$在底面$$ABC$$内的射影为$$O$$， 所以$$A_{1}O\bot
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_7d291d-Q17-img2)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_7d291d-Q17-img
2
\end{center}
...
%
\begin{center}
% IMAGE_TODO_START id=auto_7d291d-Q19-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_7d291d/media/image8.png width=60% inline=false question_index=19 sub_index=1
% CONTEXT_AFTER: 由题设，切线的斜率必定存在，设斜率为$$k$$，得到切线方程为$$y - y_{0} = k(x
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_7d291d-Q19-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_7d291d-Q19-img
1
\end{center}
%
