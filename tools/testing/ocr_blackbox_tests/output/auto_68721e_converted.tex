...
\begin{center}
% IMAGE_TODO_START id=auto_68721e-Q11-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_68721e/media/image2.png width=60% inline=false question_index=11 sub_index=1
% CONTEXT_AFTER: 
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_68721e-Q11-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_68721e-Q11-img
1
\end{center}
...
\begin{center}
% IMAGE_TODO_START id=auto_68721e-Q14-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_68721e/media/image3.png width=60% inline=false question_index=14 sub_index=1
% CONTEXT_BEFORE: {2}b$$. 情形1： 如图1，折痕$$PQ \geq AB = b$$.
% CONTEXT_AFTER: 情形2： 如图2，$$AF = {\cos\angle AFE} = \fr
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_68721e-Q14-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_68721e-Q14-img
1
\end{center}


\begin{center}
% IMAGE_TODO_START id=auto_68721e-Q14-img2 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_68721e/media/image4.png width=60% inline=false question_index=14 sub_index=1
% CONTEXT_AFTER: 情形3： 如图3.当$$F$$与$$O$$重合时，$$PQ$$取得最小值. 如图4，此时$$
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_68721e-Q14-img2)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_68721e-Q14-img
2
\end{center}
...
\begin{center}
% IMAGE_TODO_START id=auto_68721e-Q14-img3 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_68721e/media/image5.png width=60% inline=false question_index=14 sub_index=1
...
\begin{center}
% IMAGE_TODO_START id=auto_68721e-Q14-img4 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_68721e/media/image6.png width=60% inline=false question_index=14 sub_index=1
% CONTEXT_BEFORE: ex/output/figures/auto\_68721e/media/image5.png)
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_68721e-Q14-img4)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_68721e-Q14-img
4
\end{center}
...
\begin{center}
% IMAGE_TODO_START id=auto_68721e-Q18-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_68721e/media/image7.png width=60% inline=false question_index=18 sub_index=1
% CONTEXT_BEFORE: 分别在直线$$BC,AC_{1}$$上，$$MN\bot BC,MN\bot AC_{1}$$．
% CONTEXT_AFTER: (1)证明：$$MN\bot$$平面$$AB_{1}C_{1}$$； (2)求线段$$MN$$
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_68721e-Q18-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_68721e-Q18-img
1
\end{center}


\begin{center}
% IMAGE_TODO_START id=auto_68721e-Q18-img2 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_68721e/media/image8.png width=60% inline=false question_index=18 sub_index=1
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_68721e-Q18-img2)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_68721e-Q18-img
2
\end{center}
