...
\begin{center}
% IMAGE_TODO_START id=auto_b770b2-Q8-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_b770b2/media/image2.png width=60% inline=false question_index=8 sub_index=1
...
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_b770b2-Q8-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_b770b2-Q8-img
1
\end{center}


\begin{center}
% IMAGE_TODO_START id=auto_b770b2-Q8-img3 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_b770b2/media/image4.png width=60% inline=false question_index=8 sub_index=1
% CONTEXT_BEFORE: $${16}$$，则边长之比为$$1:4$$，即"小三角形"边长为1.然后如图：
% CONTEXT_AFTER: 设圆的半径为$$r$$，由余弦定理可得$$BD = + AB^{2}
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_b770b2-Q8-img3)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_b770b2-Q8-img
3
\end{center}
...
%
% IMAGE_TODO_START id=auto_b770b2-Q8-img2 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_b770b2/media/image3.png width=60% inline=true question_index=8 sub_index=1
% CONTEXT_BEFORE: _{\bigtriangleup A_{1}B_{1}C_{1}} = 4$$，
\begin{tikzpicture}[scale=0.8,baseline=-0.5ex]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_b770b2-Q8-img2)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_b770b2-Q8-img
2
...
\item \begin{center}
% IMAGE_TODO_START id=auto_b770b2-Q10-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_b770b2/media/image5.png width=60% inline=false question_index=10 sub_index=1
...
\item \begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_b770b2-Q10-img1)
\item \end{tikzpicture}
% IMAGE_TODO_END id=auto_b770b2-Q10-img
\item 1
\item \end{center}


\item \begin{center}
% IMAGE_TODO_START id=auto_b770b2-Q10-img2 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_b770b2/media/image6.png width=60% inline=false question_index=10 sub_index=1
% CONTEXT_BEFORE: t{sin}x$$和$$h(x) = 2x$$的图像，取位于上方的部分即可：
% CONTEXT_AFTER: 由图可知，AC错误，B正确， 对于D，计算知$$2x$$与$$2\text
\item \begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_b770b2-Q10-img2)
\item \end{tikzpicture}
% IMAGE_TODO_END id=auto_b770b2-Q10-img
\item 2
\item \end{center}
...
\begin{center}
% IMAGE_TODO_START id=auto_b770b2-Q13-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_b770b2/media/image7.png width=60% inline=false question_index=13 sub_index=1
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_b770b2-Q13-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_b770b2-Q13-img
1
\end{center}
...
\begin{center}
% IMAGE_TODO_START id=auto_b770b2-Q16-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_b770b2/media/image8.png width=60% inline=false question_index=16 sub_index=1
% CONTEXT_BEFORE: $，$$\angle ABC = 45{^\circ}$$，$$BC_{1}\bot AC$$.
% CONTEXT_AFTER: (1)证明：$$AC\bot$$平面$$ABC_{1}$$； (2)若$$CC_{1} = 2
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_b770b2-Q16-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_b770b2-Q16-img
1
\end{center}
...
建立如图所示的空间直角坐标系，\par
%
% IMAGE_TODO_START id=auto_b770b2-Q16-img2 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_b770b2/media/image9.png width=60% inline=true question_index=16 sub_index=1
% CONTEXT_BEFORE: iangleup ABC_{1}$$所在平面为$$xAz$$平面，建立如图所示的空间直角坐标系，
% CONTEXT_AFTER: $$\therefore A(0,0,0)$$，$$B(2,0,0)$$，$$C(0,2,0)$$，
\begin{tikzpicture}[scale=0.8,baseline=-0.5ex]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_b770b2-Q16-img2)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_b770b2-Q16-img
2
\(\therefore A(0,0,0)\)，
...
\begin{center}
% IMAGE_TODO_START id=auto_b770b2-Q17-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_b770b2/media/image10.png width=60% inline=false question_index=17 sub_index=1
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_b770b2-Q17-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_b770b2-Q17-img
1
\end{center}
