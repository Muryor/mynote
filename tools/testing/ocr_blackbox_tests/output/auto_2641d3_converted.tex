...
\begin{center}
% IMAGE_TODO_START id=auto_2641d3-Q4-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_2641d3/media/image2.png width=60% inline=false question_index=4 sub_index=1
...
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_2641d3-Q4-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_2641d3-Q4-img
1
\end{center}
...
\begin{center}
% IMAGE_TODO_START id=auto_2641d3-Q9-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_2641d3/media/image3.png width=60% inline=false question_index=9 sub_index=1
% CONTEXT_BEFORE: s {4} = {4}$$. 故选项D正确. 
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_2641d3-Q9-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_2641d3-Q9-img
1
\end{center}
...
\begin{center}
% IMAGE_TODO_START id=auto_2641d3-Q14-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_2641d3/media/image4.png width=60% inline=false question_index=14 sub_index=1
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_2641d3-Q14-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_2641d3-Q14-img
1
\end{center}
...
\begin{center}
% IMAGE_TODO_START id=auto_2641d3-Q15-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_2641d3/media/image5.png width=60% inline=false question_index=15 sub_index=1
% CONTEXT_AFTER: (1)求$$f(x)$$的解析式及其单调增区间； (2)若$$x \in \lbra
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_2641d3-Q15-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_2641d3-Q15-img
1
\end{center}
...
\begin{center}
% IMAGE_TODO_START id=auto_2641d3-Q17-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_2641d3/media/image6.png width=60% inline=false question_index=17 sub_index=1
% CONTEXT_BEFORE: t$$平面$$ABCD,QD\bot$$平面$$ABCD$$，且$$PA = QD = 8$$.
% CONTEXT_AFTER: (1)求证：$$PA//$$平面$$QCD$$； (2)求直线$$QB$$与平面$$PCD$$
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_2641d3-Q17-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_2641d3-Q17-img
1
\end{center}


\begin{center}
% IMAGE_TODO_START id=auto_2641d3-Q17-img2 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_2641d3/media/image7.png width=60% inline=false question_index=17 sub_index=1
% CONTEXT_AFTER: (3)连接$$PQ$$，由$$PA//QD$$且$$PA = QD$$，可得：四边形$$APQD
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_2641d3-Q17-img2)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_2641d3-Q17-img
2
\end{center}
...
\begin{center}
% IMAGE_TODO_START id=auto_2641d3-Q17-img3 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_2641d3/media/image8.png width=60% inline=false question_index=17 sub_index=1
% CONTEXT_BEFORE: + 6 \times 4 \times {2} \times 3 = 60$$.
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_2641d3-Q17-img3)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_2641d3-Q17-img
3
\end{center}
...
\begin{center}
% IMAGE_TODO_START id=auto_2641d3-Q19-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_2641d3/media/image9.png width=60% inline=false question_index=19 sub_index=1
% CONTEXT_BEFORE: = c$$，可得$$b = $$， 如图，作出符合题意的图形，
% CONTEXT_AFTER: 设$$PQ = QR = RP = m$$，则$$\bigtriangleup PQR$$是等边
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_2641d3-Q19-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_2641d3-Q19-img
1
\end{center}


\begin{center}
% IMAGE_TODO_START id=auto_2641d3-Q19-img2 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_2641d3/media/image10.png width=60% inline=false question_index=19 sub_index=1
% CONTEXT_AFTER: 由锐角三角函数的定义得$${\tan B} = {CD} =
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_2641d3-Q19-img2)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_2641d3-Q19-img
2
\end{center}
