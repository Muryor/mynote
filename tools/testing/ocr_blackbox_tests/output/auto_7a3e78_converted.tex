...
\begin{center}
% IMAGE_TODO_START id=auto_7a3e78-Q7-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_7a3e78/media/image2.png width=60% inline=false question_index=7 sub_index=1
% CONTEXT_AFTER: 由图可知，两函数图象有6个交点. 
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_7a3e78-Q7-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_7a3e78-Q7-img
1
\end{center}
...
\begin{question}
设计一条美丽的丝带,其造型
% IMAGE_TODO_START id=auto_7a3e78-Q11-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_7a3e78/media/image3.png width=60% inline=true question_index=11 sub_index=1
...
\begin{tikzpicture}[scale=0.8,baseline=-0.5ex]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_7a3e78-Q11-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_7a3e78-Q11-img
1
...
\begin{center}
% IMAGE_TODO_START id=auto_7a3e78-Q11-img2 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_7a3e78/media/image4.png width=60% inline=false question_index=11 sub_index=1
% CONTEXT_BEFORE: $F(2,0)$$的距离与到定直线$$x = a(a < 0)$$的距离之积为4，则( )
% CONTEXT_AFTER: > A．$$a = - 2$$ B．点$$(2,0)$$在*C*上 > > C．
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_7a3e78-Q11-img2)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_7a3e78-Q11-img
2
\end{center}
...
\begin{center}
% IMAGE_TODO_START id=auto_7a3e78-Q12-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_7a3e78/media/image5.png width=60% inline=false question_index=12 sub_index=1
% CONTEXT_BEFORE: rac{6}{4} = {2}$$. $${2}$$
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_7a3e78-Q12-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_7a3e78-Q12-img
1
\end{center}
...
\begin{center}
% IMAGE_TODO_START id=auto_7a3e78-Q16-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_7a3e78/media/image6.png width=60% inline=false question_index=16 sub_index=1
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_7a3e78-Q16-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_7a3e78-Q16-img
1
\end{center}
...
%
\begin{center}
% IMAGE_TODO_START id=auto_7a3e78-Q17-img1 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_7a3e78/media/image7.png width=60% inline=false question_index=17 sub_index=1
% CONTEXT_BEFORE: *ABCD*，$$PA = AC = 2$$，$$BC = 1,AB = $$．
% CONTEXT_AFTER: (1)若$$AD\bot PB$$，证明：$$AD$$平面$$PBC$$；
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_7a3e78-Q17-img1)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_7a3e78-Q17-img
1
\end{center}
%

\begin{center}
% IMAGE_TODO_START id=auto_7a3e78-Q17-img2 path=/Users/muryor/code/mynote/word\\_to\\_tex/output/figures/auto\\_7a3e78/media/image8.png width=60% inline=false question_index=17 sub_index=1
% CONTEXT_BEFORE: sqrt{6}$$，解得$$x = $$，即$$AD = $$．
\begin{tikzpicture}[scale=1.05,>=Stealth,line cap=round,line join=round]
  % TODO: AI_AGENT_REPLACE_ME (id=auto_7a3e78-Q17-img2)
\end{tikzpicture}
% IMAGE_TODO_END id=auto_7a3e78-Q17-img
2
\end{center}
